  ...
  implements OnInit
{
  ...
  public filters: Array<{ name: string; value: string; checked: boolean }> = [
    { name: 'work', value: 'Trabajo', checked: true },
    { name: 'personal', value: 'Personal', checked: true },
    { name: 'important', value: 'Importante', checked: true },
    { name: 'travel', value: 'Viaje', checked: true },
    { name: 'friends', value: 'Otros', checked: true },
  ];
