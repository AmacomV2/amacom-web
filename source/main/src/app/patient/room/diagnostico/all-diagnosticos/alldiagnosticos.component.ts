...
import { DeleteDiagnosticoComponent } from './dialog/delete/delete.component';
import { DiagnosticoList } from './diagnostico.model';
import { FormDialogDiagnosticoComponent } from './dialog/form-dialog/form-dialog.component';
...
export class AllDiagnosticosComponent
  ...
  implements OnInit
{
  public listaDiagnosticos: Array<any> = [];
  ...
  addNew() {
    this.router.navigate(['/patient/room/diagnostico/add-diagnostico']);
  }
  search(row: DiagnosticoList) {
    this.id = row.id;
    this.pasoParametrosService.adicionarParametro('data', row);
    this.router.navigate(['/patient/room/diagnostico/search-diagnostico']);
  }
  ...
  llenarLista(){
    this.listaDiagnosticos = [
     {id:1, alerta:"Alerta 1", resultado:"resultado 1", estado:"estado 1", date:"11/11/2011"},
     {id:2, alerta:"Alerta 2", resultado:"resultado 2", estado:"estado 2", date:"22/22/2022"},
     {id:3, alerta:"Alerta 3", resultado:"resultado 3", estado:"estado 3", date:"33/33/2033"},
    ];
  }
}
