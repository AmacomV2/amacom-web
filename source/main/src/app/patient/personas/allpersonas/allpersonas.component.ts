  ...
  implements OnInit
{
  ...
  addNew() {
    this.router.navigate(['/patient/personas/add-persona']);
  }
  search(row: PersonaList) {
    this.id = row.id;
    this.pasoParametrosService.adicionarParametro('data', row);
    this.router.navigate(['/patient/personas/search-persona']);
  }
  ...
  llenarLista(){
    this.listaPersonas = [
     {id:1, nombre:"Valentina", apellido:"Escobar", tipoDocumento:"CC", numeroDocumento:"11111111", genero: "Femenino", direccion: "Gironcity", estadoCivil: "desconocido", fechaNacimiento: "27/06/2001", ocupacion: "hermosa", estado:"Activo", date:"11/11/2011"},
     {id:2, nombre:"Hecta", apellido:"Vallejo", tipoDocumento:"CC", numeroDocumento:"22222222", genero: "Femenino", direccion: "Bucaramanga", estadoCivil: "desconocido", fechaNacimiento: "28/08/1998", ocupacion: "lokura", estado:"Inactivo", date:"22/22/2022"},
     {id:3, nombre:"Yisus", apellido:"Vargas", tipoDocumento:"CC", numeroDocumento:"33333333", genero: "Desconocido", direccion: "Bucaramanga", estadoCivil: "desconocido", fechaNacimiento: "22/02/2222", ocupacion: "todo lo puede", estado:"Activo", date:"33/33/2033"}
    ];
  }
}
